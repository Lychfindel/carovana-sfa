...
<main class="home">
  <aside class="sidebar" id="sidebar" aria-live="polite">
    <section id="view-list">
      ...
      <div class="legend">
        <span><i class="dot dot-next"></i> In programma</span>
        <span><i class="dot dot-past"></i> Già svolta</span>
      </div>
      <div class="tabs" role="tablist">
        <button role="tab" class="tab" data-filter="next" aria-selected="true">In programma <b id="n-next">0</b></button>
        <button role="tab" class="tab" data-filter="past" aria-selected="false">Già svolte <b id="n-past">0</b></button>
      </div>
      <ul class="list" id="list"></ul>
      <p class="empty" id="empty" hidden></p>
    </section>
    <section id="view-detail" hidden>
      <button class="back" id="back">← Tutte le iniziative</button>
